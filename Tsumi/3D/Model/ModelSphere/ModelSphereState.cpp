...
/// 描画処理
/// </summary>
void ModelSphereState::Draw(Model* pModel, WorldTransform worldTransform, BaseCamera* camera) {
...
/// コマンドコール処理
/// </summary>
void ModelSphereState::CommandCall(uint32_t texture, WorldTransform worldTransform, BaseCamera* camera) {
